...
- The original SM-18 data is from Leee (a SuperMemo user in China) and me. So the results are based on the data from Leee and me. It may be different from the result of other SM-18 users.
